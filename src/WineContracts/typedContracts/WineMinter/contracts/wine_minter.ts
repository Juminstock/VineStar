...
import { ContractAbi } from '../contract-info/wine_minter';
import QueryMethods from '../query/wine_minter';
import BuildExtrinsicMethods from '../build-extrinsic/wine_minter';
import TxSignAndSendMethods from '../tx-sign-and-send/wine_minter';
import MixedMethods from '../mixed-methods/wine_minter';
import EventsClass from '../events/wine_minter';
