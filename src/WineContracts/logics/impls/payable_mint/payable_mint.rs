    ...
    + Internal
{
    ...
    fn set_base_uri(&mut self, uri: String) -> Result<(), PSP34Error> {
        ...
        metadata::Internal::_set_attribute(self, id, String::from("Base URI"), uri);
    ...
    /// Set max number of wines which could be minted per call
    #[ink(message)]
    #[modifiers(only_owner)]
    ...
    /// Get max supply of wines in collections
    #[ink(message)]
    ...
    /// Get max number of wines which could be minted per call
    #[ink(message)]
